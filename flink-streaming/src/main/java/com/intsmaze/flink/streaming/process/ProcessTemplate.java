...
public class ProcessTemplate {
     ...
     * @date: 2020/10/15 18:33
     */
    public static class ProcessSource implements SourceFunction<Tuple2<String, Long>> {
     ...
     * @date: 2020/10/15 18:33
     */
    public static class EventTimeWaterMarks implements AssignerWithPeriodicWatermarks<Tuple2<String, Long>> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple2<String, Long>> source = env.addSource(new ProcessSource())
     ...
     * @date: 2020/10/15 18:33
     */
    public static class SessionProcess extends ProcessFunction<Tuple2<String, Long>, Tuple2<String, Integer>> {
        ...
        public void open(Configuration parameters) {
            ValueStateDescriptor<CountWithTimestamp> valueStateDescriptor =
        ...
        public void processElement(Tuple2<String, Long> value, Context ctx,
            ...
            timerService.registerEventTimeTimer(current.lastModified + 10000);
        }
